	...
	<section class="section-contact bg1-pattern p-t-90 p-b-113">
		...
		<div class="container">
			<div class="map bo8 bo-rad-10 of-hidden">
				<div class="contact-map size37" id="google_map" data-map-x="40.704644" data-map-y="-74.011987" data-pin="assets/userstyl/images/icons/icon-position-map.png" data-scrollwhell="0" data-draggable="1"></div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="row p-t-135">
				<div class="col-sm-8 col-md-4 col-lg-4 m-l-r-auto p-t-30">
					<div class="dis-flex m-l-23">
						<div class="p-r-40 p-t-6">
							<img src="assets/userstyle/images/icons/map-icon.png" alt="IMG-ICON">
						</div>
				...
				<div class="col-sm-8 col-md-3 col-lg-4 m-l-r-auto p-t-30">
					<div class="dis-flex m-l-23">
						<div class="p-r-40 p-t-6">
							<img src="assets/userstyle/images/icons/phone-icon.png" alt="IMG-ICON">
						</div>
				...
				<div class="col-sm-8 col-md-5 col-lg-4 m-l-r-auto p-t-30">
					<div class="dis-flex m-l-23">
						<div class="p-r-40 p-t-6">
							<img src="assets/userstyle/images/icons/clock-icon.png" alt="IMG-ICON">
						</div>
...
<!--===============================================================================================-->
	...
	<script src="{{asset ('assets/userstyle/js/map-custom.js') }}"></script>
<!--===============================================================================================-->
